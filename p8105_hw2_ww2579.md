...
This dataset contains data about NYC subway stations’ names, routes and
geographical locations. Also, it includes information of the entrance
type, whether there is an entry or vending, and whether or not the ADA
is complied with. By far, I have cleaned up variable names to
lower\_snake\_case, and selected only the columns of variables that I am
interested in. There are 1868 rows and 19 columns of the resulting
dataset. These data are currently not tidy at all, because for example,
some columns could have been combined together for tidiness.
